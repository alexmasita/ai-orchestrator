...
# Idle timeout (orchestrator-controlled)
...
if [ ! -f "$SETUP_MARKER" ]; then
    ...
    touch "$SETUP_MARKER"
    update_state "setup_complete" "complete" "First-time setup finished. Take a snapshot now."
fi
...
echo "============================================"
echo "  Architect (120B AWQ):  http://localhost:$ARCHITECT_PORT  (0.55 VRAM)"
echo "  Developer (30B AWQ):   http://localhost:$DEVELOPER_PORT  (0.25 VRAM)"
